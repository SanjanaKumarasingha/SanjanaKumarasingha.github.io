...
import portfolioImg from "@/../public/images/sanjana1.jpg";
          ...
          <div className="group relative w-full">
            <div className="text-md relative z-40 flex flex-col gap-3 font-semibold tracking-wide text-primary lg:absolute lg:right-0 lg:top-[27%] lg:block lg:max-w-[580px] lg:text-start lg:text-lg xl:top-1/3 xl:h-[442px] xl:max-w-[650px]">
              <div className="flex h-full flex-col justify-center gap-6">
                <span>
                    I am a Third Year Computer Science & Engineering student at the University of Moratuwa with a passion for software engineering. I believe in the transformative power of technology and eager to apply my academic knowledge in real-world scenarios. My goal is to gain valuable industry experience, enhance my skills, and contribute meaningfully to innovative and mind-blowing projects. As I take my first steps into the professional world, and committed to learning, problem-solving, and making a positive impact through technology.
                </span>
                <span>
                  Seeking for Software Engineering opportunities where I can leverage
                ...
                <p className="flex flex-col items-start sm:items-center lg:items-start">
                  ...
                  >
                    <button className="bg-[#b4bfff] text-2xl font-bold uppercase dark:bg-[#ddbea9] lg:normal-case">
                      Contact me!
                    </button>
                  </Link>
                </p>
            ...
            <div className="absolute z-30 hidden lg:left-0 lg:top-1/4 lg:block">
              <div className="relative h-72 w-72 lg:h-[380px] lg:w-[380px] xl:h-[470px] xl:w-[470px]">
                <div className="absolute inset-0 z-20 rounded-full bg-gradient-to-b from-[#edf9fc] via-[#a0e0e0] to-[#b0dde1] transition-opacity group-hover:opacity-0"></div>

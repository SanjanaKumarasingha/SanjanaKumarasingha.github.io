        ...
        <div className="container flex flex-col items-start justify-center tracking-wide text-black dark:text-white">
          <div className="container relative flex h-full w-full flex-col items-center">
            <div className="h-72 w-[280px] text-center text-[2rem] font-extrabold sm:w-[520px] md:w-[700px] lg:mb-5 lg:w-[920px] lg:text-[3rem]">
              ...
              <br />
              <TextAnimation delay={1} baseText={`I'm Sanjana Kumarasingha`} />
            </div>
            <motion.div
            ...
            >
              <a
                className="group flex w-64 cursor-pointer items-center justify-center gap-2 rounded-full bg-darkBg px-7 py-3 text-white outline-none transition hover:bg-[#c2cbfc] hover:text-black hover:dark:text-black sm:w-auto"
                onClick={(e) => {
              ...
              <a
                className="borderBlack group flex w-64 cursor-pointer items-center justify-center gap-2 rounded-full bg-white px-7 py-3 text-black outline-none transition hover:bg-[#cfd5f6] dark:bg-white/10 dark:text-white dark:hover:bg-white/20 sm:w-auto"
                href="/CV_Sanjana.pdf"
                download
              >
              ...
              <div className="flex gap-2">
                <a
                  ...
                  href="https://www.linkedin.com/in/sanjana-kumarasingha/"
                  target="_blank"
                >
                  <Linkedin />
                </a>
                <a
                  ...
                  href="https://github.com/SanjanaKumarasingha"
                  target="_blank"
                >
                  <Image
                    width={25}

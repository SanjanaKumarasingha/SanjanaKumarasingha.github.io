...
export default function RedoTextAnimation({ delay }: IRedoTextAnimationProps) {
  ...
  const texts = [
    "I’m Passionate about learning, ready to contribute!",
    "Transforming ideas into digital reality, let’s start magic!",
  ...
  return (
    <motion.span className="h-32 max-w-96 bg-[#b4bfff] text-[1.2rem] font-bold dark:bg-[#1d4ed8] md:text-[1.5rem] lg:text-[1.7rem]">
      {displayText}
    </motion.span>
  );
}
